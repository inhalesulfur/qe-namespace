            ...
            function constructor() {
                ...
                self.set = function(key, value){
                    ...
                    if (st && constr){
                        ...
                        if (!checkInstance){
                            throw new TypeError("setted value is not an instance of " + className);
                        }
                    }
                    self[key] = value;
                    return self;
                ...
                each.call(struct, function(prop, propName){
                    ...
                    if (prop.type == "array"){
                        ...
                        self[propName].push = function(value){
                            if (constr){
                                var checkInstance = value instanceof constr;
                                if (!checkInstance){
                                    throw new TypeError("pushed value is not an instance of " + className);
                                }
                            }
                    ...
                    if (prop.type == "object"){
                        self.set[propName] = function(object){
                            ...
                            if (!checkInstance){
                                throw new TypeError("setted object is not an instance of " + className);
                            }
