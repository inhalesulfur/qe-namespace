		...
		return new Promise((resolve, reject) => {
			...
			rows.each(function (d, i){
				...
				if (checkOneOf){
					...
					var instanceOf = findNotEqualInArray([pPathHtml, sPathHtml, iHtml], "");
					attr.class = instanceOf?instanceOf:attrTypeHtml;
					attr.class = attr.class.trim();
					if (structsMap[instanceOf]){
						attr.type = "object";
						...
						attr.type = "primitive";
						//attr.setter = "basic";
						attr.class = getType(attr.class);
						if (types[attr.class]){							
							//attr.setter = "checkValue";
							attr.values = parseLi(types[attr.class].li);
						}
						else if (attr.class == "JSON"){
